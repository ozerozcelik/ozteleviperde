...
export default function WhatsAppButton({
  phoneNumber = '+902125550123',
  message = 'Merhaba, ÖzTelevi hakkında bilgi almak istiyorum.',
  className = '',
}: WhatsAppButtonProps) {
  ...
  return (
    <div className={`fixed bottom-6 right-6 z-50 ${className}`}>
      ...
      >
        <div className="bg-foreground text-background text-sm px-4 py-2 rounded-lg shadow-lg">
          WhatsApp ile ulaşın
          <div className="absolute -bottom-1 right-5 w-2 h-2 bg-foreground transform rotate-45" />
        </div>
      </div>
