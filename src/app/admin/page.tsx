                              ...
                              <>
                                ...
                                {section.key === 'collections-featured' || section.key === 'collections-all' ? (
                                  <div className="rounded-xl border border-blue-200 bg-blue-50 px-4 py-3 text-sm text-blue-800">
                                    Bu bölüm artık kart listesini değil sadece bölüm başlığı ve açıklamasını yönetir.
                                    Ürün kartlarını düzenlemek için sol menüden <strong>Ürünler</strong> sekmesini kullan.
                                  </div>
