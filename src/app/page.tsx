        ...
        <div className="flex flex-col md:flex-row items-center gap-8 md:gap-12">
          ...
          <div className="flex-1 text-center md:text-left">
            ...
            <h2 className="text-2xl md:text-3xl font-light text-foreground mb-3">
              Perdelerinizi <span className="font-normal italic">Görselleştirin</span>
            </h2>
            <p className="text-muted-foreground mb-6 max-w-lg">
              Oda görselleştiricimiz ile farklı perde stillerini ve renklerini mekanınızda önizleyin.
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 relative">
        ...
        <div className="max-w-3xl mb-16 md:mb-24">
          ...
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-light text-foreground leading-tight mb-6 opacity-0 translate-y-8 animate-fade-in-up stagger-1 in-view:opacity-100 in-view:translate-y-0 in-view:duration-1000">
            Daha az, ama{' '}
            <span className="font-normal italic">anlamlı</span> daha iyi
          </h2>
          <p className="text-lg text-muted-foreground leading-relaxed opacity-0 translate-y-8 animate-fade-in-up stagger-2 in-view:opacity-100 in-view:translate-y-0 in-view:duration-1000">
            &quot;Komorebi&quot; — yapraklar arasından süzülen nazik güneş ışığı — 
            kavramından ilham alarak, evleri sığınağa dönüştüren tekstiller oluşturuyoruz.
          </p>
        </div>
    ...
    >
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="text-center max-w-2xl mx-auto mb-16 md:mb-24">
          ...
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-light text-foreground leading-tight mb-6 opacity-0 translate-y-8 animate-fade-in-up stagger-1 in-view:opacity-100 in-view:translate-y-0 in-view:duration-1000">
            Farkında yaşama{' '}
            <span className="font-normal italic">uygun</span> tasarım
          </h2>
          <p className="text-lg text-muted-foreground leading-relaxed opacity-0 translate-y-8 animate-fade-in-up stagger-2 in-view:opacity-100 in-view:translate-y-0 in-view:duration-1000">
            Koleksiyonumuzdaki her parça, yaşam alanlarınıza uyum, sıcaklık ve
            doğal güzellik getirmek için tasarlanmıştır.
          </p>
        </div>
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 relative">
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          ...
          <div>
            ...
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-light text-foreground leading-tight mb-6 opacity-0 translate-y-8 animate-fade-in-up stagger-1 in-view:opacity-100 in-view:translate-y-0 in-view:duration-1000">
              <span className="font-normal italic">Niyetle</span>{' '}
              üretildi
            </h2>
            <p className="text-lg text-muted-foreground leading-relaxed mb-8 opacity-0 translate-y-8 animate-fade-in-up stagger-2 in-view:opacity-100 in-view:translate-y-0 in-view:duration-1000">
              Her ÖzTelevi tekstilinin arkasında bir özveri, hassasiyet ve
              zanaata derin saygı hikayesi yatar. Onlarca yıldır tekniklerini
              mükemmelleştiren ustalarla çalışırız, böylece her parça insan
              elinin sıcaklığını taşır.
            </p>
            ...
            {features.map((feature, index) => (
              ...
              >
                <div className="w-10 h-10 rounded-full bg-wood-100 flex items-center justify-center mb-4">
                  <div className="w-5 h-5 text-wood-600">{feature.icon}</div>
                </div>
    ...
    >
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="text-center max-w-2xl mx-auto mb-16 md:mb-24">
          ...
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-light text-foreground leading-tight mb-6 opacity-0 translate-y-8 animate-fade-in-up stagger-1 in-view:opacity-100 in-view:translate-y-0 in-view:duration-1000">
            <span className="font-normal italic">Sığınağınızı</span>{' '}
            dönüştürün
          </h2>
          <p className="text-lg text-muted-foreground leading-relaxed opacity-0 translate-y-8 animate-fade-in-up stagger-2 in-view:opacity-100 in-view:translate-y-0 in-view:duration-1000">
            ÖzTelevi tekstillerinin huzur ve bağlantı ilham eden,
            ışık dolu mekanlar nasıl yarattığını görün.
          </p>
        </div>
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 relative">
        ...
        <div className="text-center max-w-2xl mx-auto mb-16 md:mb-24">
          ...
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-light text-foreground leading-tight opacity-0 translate-y-8 animate-fade-in-up stagger-1 in-view:opacity-100 in-view:translate-y-0 in-view:duration-1000">
            <span className="font-normal italic">Huzur</span>{' '}
            hikayeleri
          </h2>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          ...
          <div>
            ...
            <p className="text-lg text-background/80 leading-relaxed mb-8 opacity-0 translate-y-8 animate-fade-in-up stagger-2 in-view:opacity-100 in-view:translate-y-0 in-view:duration-1000">
              Evinizi huzurlu bir sığınağa dönüştürmenize yardımcı olalım.
              Tasarım danışmanlarımız koleksiyonumuzda size rehberlik etmeye hazır.
            </p>
